...
export function ScoreBar({
  ...
  return (
    <div
      ...
      aria-hidden
    >
      {/* The 50 marker keys off fg, not line-strong: against a light-theme
          track those two greys are nearly the same value. */}
      <div className="absolute left-1/2 top-1/2 h-2.5 w-px -translate-x-1/2 -translate-y-1/2 bg-fg-subtle/50" />
      {side !== 'zero' && (
        <div
